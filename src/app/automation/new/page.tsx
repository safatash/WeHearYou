      ...
      <div className="space-y-6">
        ...
        <div className="max-w-xl panel">
          <form action={createAutomation} className="space-y-5">
            ...
            <div>
              <label className="field-label" htmlFor="triggerType">
                Trigger
              </label>
              <select
                id="triggerType"
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Link
                href="/automation"
                className="btn btn-secondary hover:bg-slate-50 transition"
              >
                Cancel
              </Link>
            </div>
