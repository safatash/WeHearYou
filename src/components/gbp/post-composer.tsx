...
import { createGbpPostInline, updateGbpPostInline, uploadGbpPostImage } from "@/app/gbp/posts/actions";
            ...
            <div>
              ...
              <input
                ...
                onChange={async (e) => {
                  ...
                  try {
                    const fd = new FormData();
                    fd.set("file", file);
                    const result = await uploadGbpPostImage(fd);
              ...
              {imageUrl ? (
                <div className="relative">
                  <img src={imageUrl} alt="Post photo" className="h-40 w-full rounded-xl object-cover border border-slate-200" />
                  <button
                    type="button"
                    onClick={() => setImageUrl("")}
                    className="absolute right-2 top-2 rounded-full bg-slate-900/60 p-1 text-white hover:bg-slate-900/80 transition"
                  >
                ...
                <button
                  ...
                  className="flex h-24 w-full cursor-pointer items-center justify-center rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 text-slate-400 hover:border-[#37aeb7]/50 hover:text-[#37aeb7] transition disabled:opacity-60"
                >
                  {imageUploading ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="mt-1 text-[12px]">Click to upload a photo</p>
                    </div>
                  )}
                </button>
              )}
