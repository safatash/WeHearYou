...
// Official multi-color Google "G" mark, used for Google-sourced reviews.
const GoogleGlyph = ({ size }: { size: number }) => (
...
const SourceBadge = ({ source, size = 18 }: { source: string; size?: number }) =>
  source === "Google" ? (
    <span style={st({ width: size, height: size, flex: "none", display: "grid", placeItems: "center" })}>
