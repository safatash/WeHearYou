...
const PRISMA_ENUMS = {
  ReviewLinkEventType: {
    ...
    AI_ASSIST_GENERATED: "AI_ASSIST_GENERATED",
    AI_ASSIST_REGENERATED: "AI_ASSIST_REGENERATED",
    AI_ASSIST_EDITED: "AI_ASSIST_EDITED",
    AI_ASSIST_COPIED: "AI_ASSIST_COPIED",
    AI_ASSIST_DEST_GOOGLE: "AI_ASSIST_DEST_GOOGLE",
    AI_ASSIST_DEST_YELP: "AI_ASSIST_DEST_YELP",
    AI_ASSIST_DEST_FACEBOOK: "AI_ASSIST_DEST_FACEBOOK",
    AI_ASSIST_DEST_TRUSTPILOT: "AI_ASSIST_DEST_TRUSTPILOT",
    AI_ASSIST_WEHEARYOU_SUBMITTED: "AI_ASSIST_WEHEARYOU_SUBMITTED",
    RESOLUTION_VIEWED: "RESOLUTION_VIEWED",
    RESOLUTION_ISSUE_SELECTED: "RESOLUTION_ISSUE_SELECTED",
    RESOLUTION_FEEDBACK_STARTED: "RESOLUTION_FEEDBACK_STARTED",
    RESOLUTION_AI_REWRITE_GENERATED: "RESOLUTION_AI_REWRITE_GENERATED",
    RESOLUTION_AI_REWRITE_ACCEPTED: "RESOLUTION_AI_REWRITE_ACCEPTED",
    RESOLUTION_FEEDBACK_SUBMITTED: "RESOLUTION_FEEDBACK_SUBMITTED",
    RESOLUTION_CONTACT_REQUESTED: "RESOLUTION_CONTACT_REQUESTED",
    RESOLUTION_CASE_CREATED: "RESOLUTION_CASE_CREATED",
    RESOLUTION_RESPONSE_DRAFTED: "RESOLUTION_RESPONSE_DRAFTED",
    RESOLUTION_CASE_RESOLVED: "RESOLUTION_CASE_RESOLVED",
    RESOLUTION_FOLLOWUP_SENT: "RESOLUTION_FOLLOWUP_SENT",
    RESOLUTION_FOLLOWUP_COMPLETED: "RESOLUTION_FOLLOWUP_COMPLETED",
  },
  ResolutionStatus: {
    NEW: "NEW", NEEDS_RESPONSE: "NEEDS_RESPONSE", CONTACTED: "CONTACTED",
    IN_PROGRESS: "IN_PROGRESS", RESOLVED: "RESOLVED", CLOSED: "CLOSED",
  },
  ResolutionPriority: { LOW: "LOW", MEDIUM: "MEDIUM", HIGH: "HIGH", CRITICAL: "CRITICAL" },
  ResolutionContactPreference: { PHONE: "PHONE", EMAIL: "EMAIL", NONE: "NONE" },
  ReviewStatus: {
    PUBLISHED: "PUBLISHED",
    PENDING: "PENDING",
    HIDDEN: "HIDDEN",
